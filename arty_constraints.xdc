...
# set_false_path -from [get_clocks clk_out2_design_1_clk_wiz_0_1] -to [get_clocks eth_tx_clk]
# set_false_path -from [get_clocks eth_tx_clk] -to [get_clocks clk_out2_design_1_clk_wiz_0_1]
...
## LEDs
# set_property -dict { PACKAGE_PIN H5    IOSTANDARD LVCMOS33 } [get_ports { high_z_probe }]; #IO_L24N_T3_35 Sch=led[4]
...
# set_property -dict { PACKAGE_PIN E16   IOSTANDARD LVCMOS33 } [get_ports { data_rdy }]; #IO_L11N_T1_SRCC_15 Sch=jb_n[1]
# set_property -dict { PACKAGE_PIN D15   IOSTANDARD LVCMOS33 } [get_ports { sys_clk_test }]; #IO_L12P_T1_MRCC_15 Sch=jb_p[2]
# set_property -dict { PACKAGE_PIN C15   IOSTANDARD LVCMOS33 } [get_ports { rmii_data[0] }]; #IO_L12N_T1_MRCC_15 Sch=jb_n[2]
# set_property -dict { PACKAGE_PIN J17   IOSTANDARD LVCMOS33 } [get_ports { rmii_data[1] }]; #IO_L23P_T3_FOE_B_15 Sch=jb_p[3]
# set_property -dict { PACKAGE_PIN J18   IOSTANDARD LVCMOS33 } [get_ports { rmii_data[2] }]; #IO_L23N_T3_FWE_B_15 Sch=jb_n[3]
# set_property -dict { PACKAGE_PIN K15   IOSTANDARD LVCMOS33 } [get_ports { rmii_data[3] }]; #IO_L24P_T3_RS1_15 Sch=jb_p[4]
# set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { sys_clk_test }]; #IO_L24N_T3_RS0_15 Sch=jb_n[4]

## Pmod Header JC
# set_property -dict { PACKAGE_PIN U12   IOSTANDARD LVCMOS33 } [get_ports { fifo_wr_vld }]; #IO_L20P_T3_A08_D24_14 Sch=jc_p[1]
# set_property -dict { PACKAGE_PIN V12   IOSTANDARD LVCMOS33 } [get_ports { wr_en_probe }]; #IO_L20N_T3_A07_D23_14 Sch=jc_n[1]
# set_property -dict { PACKAGE_PIN V10   IOSTANDARD LVCMOS33 } [get_ports { wr_full_probe }]; #IO_L21P_T3_DQS_14 Sch=jc_p[2]
# set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=jc_n[2]
...
# set_property -dict { PACKAGE_PIN T13   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L23P_T3_A03_D19_14 Sch=jc_p[4]
# set_property -dict { PACKAGE_PIN U13   IOSTANDARD LVCMOS33 } [get_ports {  }]; #IO_L23N_T3_A02_D18_14 Sch=jc_n[4]

## Pmod Header JD
set_property -dict { PACKAGE_PIN D4    IOSTANDARD LVCMOS33 } [get_ports { uart_tx }]; #IO_L11N_T1_SRCC_35 Sch=jd[1]
# set_property -dict { PACKAGE_PIN D3    IOSTANDARD LVCMOS33 } [get_ports { wr_ptr_probe[1] }]; #IO_L12N_T1_MRCC_35 Sch=jd[2]
# set_property -dict { PACKAGE_PIN F4    IOSTANDARD LVCMOS33 } [get_ports { wr_ptr_probe[2] }]; #IO_L13P_T2_MRCC_35 Sch=jd[3]
# set_property -dict { PACKAGE_PIN F3    IOSTANDARD LVCMOS33 } [get_ports { wr_ptr_probe[3] }]; #IO_L13N_T2_MRCC_35 Sch=jd[4]
# set_property -dict { PACKAGE_PIN E2    IOSTANDARD LVCMOS33 } [get_ports { rd_ptr_probe[0] }]; #IO_L14P_T2_SRCC_35 Sch=jd[7]
# set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { rd_ptr_probe[1] }]; #IO_L14N_T2_SRCC_35 Sch=jd[8]
# set_property -dict { PACKAGE_PIN H2    IOSTANDARD LVCMOS33 } [get_ports { rd_ptr_probe[2] }]; #IO_L15P_T2_DQS_35 Sch=jd[9]
# set_property -dict { PACKAGE_PIN G2    IOSTANDARD LVCMOS33 } [get_ports { rd_ptr_probe[3] }]; #IO_L15N_T2_DQS_35 Sch=jd[10]
...
# set_property -dict { PACKAGE_PIN H16   IOSTANDARD LVCMOS33 } [get_ports { rmii_tx_clk }]; #IO_L13P_T2_MRCC_15 Sch=eth_tx_clk
