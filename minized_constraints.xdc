...
# Security
# Insights
# hdl/Boards/MINIZED/minized_pins.xdc
# @LucLanglois
# LucLanglois Minized Foundation Initial release
# …
# Latest commit d03bd63 on Jun 14, 2017
#  History
#  1 contributor
# 217 lines (164 sloc)  8.6 KB
...
# # Pmod #1
# #######################################################################
set_property PACKAGE_PIN L15 [get_ports m_clk]
set_property IOSTANDARD LVCMOS33 [get_ports m_clk]

set_property PACKAGE_PIN M15 [get_ports word_select]
set_property IOSTANDARD LVCMOS33 [get_ports word_select]

set_property PACKAGE_PIN L14 [get_ports s_clk]
set_property IOSTANDARD LVCMOS33 [get_ports s_clk]

set_property PACKAGE_PIN M14 [get_ports serial_data]
...
# # Pmod #2
# #######################################################################
 set_property PACKAGE_PIN P13 [get_ports midi_in]
 set_property IOSTANDARD LVCMOS33 [get_ports midi_in]

set_property PACKAGE_PIN P14 [get_ports gui_in]
set_property IOSTANDARD LVCMOS33 [get_ports gui_in]
